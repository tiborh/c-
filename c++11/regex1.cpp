...
int main()
{
    ...
    // removed because of segfault in 4.8.2:
    ...
    //removed because of the following runtime error:
    // *** Error in `./regex1': free(): invalid next size (fast): 0x0000000001cab320 ***

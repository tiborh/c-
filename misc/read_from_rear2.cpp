...
unsigned char* empty_stack(stack<unsigned char> &st, int nuu)
{
  ...
  if (!st.empty())
    cerr << "stack should be empty at this point.\n";
...
string read_from_rear(const char* fn)
{
    ...
    stack<unsigned char> prev_chars;
    stringstream s;
...
int main(int argc, char** argv)
{
  ...
  cout << read_from_rear("murphy.txt");
